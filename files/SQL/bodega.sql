...
-- Tiempo de generación: 21-06-2024 a las 17:52:12
...
CREATE TABLE `1_formularioweb` (
  ...
  `tot_personas_inscritas` int(11) UNSIGNED NOT NULL,
  ...
  `coordinador_celular` int(25) DEFAULT NULL,
  `responsable_nombre` varchar(150) DEFAULT NULL,
  `responsable_correo` varchar(100) DEFAULT NULL,
  `responsable_telefono` int(25) DEFAULT NULL,
  `responsable_celular` int(25) DEFAULT NULL
...
CREATE TABLE `3_sena` (
  ...
  `ID_PUNTO_AT` bigint(20) NOT NULL,
  `MES` int(3) NOT NULL,
  `AÑO` int(5) NOT NULL,
  ...
  `MUNICIPIO` varchar(255) NOT NULL,
  `INSCRITOS_MUJER` bigint(20) NOT NULL,
  `INSCRITOS_HOMBRE` bigint(20) NOT NULL,
  `INSCRITOS_JOVENES_MUJER` bigint(20) NOT NULL,
  `INSCRITOS_JOVENES_HOMBRE` bigint(20) NOT NULL,
  `INSCRITOS_PCD_MUJER` bigint(20) NOT NULL,
  `INSCRITOS_PCD_HOMBRE` bigint(20) NOT NULL,
  `INSCRITOS_RUV_MUJER` bigint(20) NOT NULL,
  `INSCRITOS_RUV_HOMBRE` bigint(20) NOT NULL,
  `ORIENTADOS_MUJER_IND` bigint(20) NOT NULL,
...
CREATE TABLE `4_base` (
  ...
  `id_prestador_cipres` int(11) NOT NULL,
  ...
  `divipola_asociada_a_la_url` int(11) DEFAULT NULL,
  `segunda_direccion` text DEFAULT NULL,
  `convenio` text DEFAULT NULL,
  `tipo_de_prestador` varchar(255) DEFAULT NULL,
  `naturaleza_del_prestador_publico_privado` varchar(255) DEFAULT NULL,
  `clase_de_prestador` text DEFAULT NULL,
  `tipo_de_ccf` varchar(255) DEFAULT NULL,
  `clase_ente_territorial` varchar(255) DEFAULT NULL,
  `modalidad_de_prestacion_del_servicio` varchar(255) DEFAULT NULL,
  `tipo_de_punto_de_atencion` text NOT NULL,
  `modalidad_de_prestación_del_servicio` varchar(255) NOT NULL,
  `municipios_que_recorre_la_estrategia_movil` text DEFAULT NULL,
  `pagina_web` text DEFAULT NULL,
  `nombre_del_representante_legal` varchar(255) DEFAULT NULL,
  `tipo_de_documento` varchar(255) DEFAULT NULL,
  `numero_de_identificacion` varchar(255) DEFAULT NULL,
  `correo_electronico_representante_legal` varchar(255) DEFAULT NULL,
  `telefono_representante_legal` varchar(255) DEFAULT NULL,
  `celular_representante_legal` varchar(255) DEFAULT NULL,
  `direccion_de_correspondencia` varchar(255) DEFAULT NULL,
  `coordinador_principal` varchar(255) DEFAULT NULL,
  `tipo_de_documento_coordinador_principal` varchar(255) DEFAULT NULL,
  `cedula_coordinador_principal` varchar(255) DEFAULT NULL,
  `telefono_coordinador_principal` varchar(255) DEFAULT NULL,
  `celular_coordinador_principal` varchar(255) DEFAULT NULL,
  `correo_coordinador_principal` text DEFAULT NULL,
  `coordinador_punto_de_atencion` text DEFAULT NULL,
  `tipo_de_documento_coordinador` varchar(255) DEFAULT NULL,
  `numero_de_identificacion_coordinador` varchar(255) DEFAULT NULL,
  `telefono_de_contacto_coordinador_punto_de_atencion` varchar(255) DEFAULT NULL,
  `celular_coordinador_punto_de_atencion` varchar(255) DEFAULT NULL,
  ...
  `telefono_punto_de_atencion` int(11) DEFAULT NULL,
  ...
  `fechas_de_resoluciones_de_autorizacion` varchar(255) DEFAULT NULL,
  `resolucion_de_modificacion` varchar(100) DEFAULT NULL,
  `fecha_de_resolucion_de_modificacion` varchar(255) DEFAULT NULL,
  `resolucion_de_negacion` varchar(100) DEFAULT NULL,
  `fecha_de_resolucion_de_negacion` varchar(255) DEFAULT NULL,
  `resolucion_de_desistimiento` varchar(100) DEFAULT NULL,
  `fecha_de_resolucion_de_desistimiento` varchar(255) DEFAULT NULL,
  `resolucion_de_recursos` varchar(100) DEFAULT NULL,
  `fecha_de_resolucion_de_recursos` varchar(255) DEFAULT NULL,
  `resolucion_de_revocaroria` varchar(100) DEFAULT NULL,
  `fecha_de_resolucion_de_revocaroria` varchar(255) DEFAULT NULL,
  `resolucion_de_aclaracion_o_correccion_error` varchar(100) DEFAULT NULL,
  `fecha_de_resolucion_de_aclaracion_o_correccion_error` varchar(255) DEFAULT NULL,
  `otras_resoluciones` varchar(100) DEFAULT NULL,
  `fecha_de_otras_resoluciones` varchar(255) DEFAULT NULL,
  `resolución_vigente` varchar(100) DEFAULT NULL,
  `fecha_de_resolucion_vigente` varchar(255) DEFAULT NULL,
  `fecha_de_notificacion_de_resolucion` varchar(255) DEFAULT NULL,
  `fecha_ejecutoria_de_resolucion` varchar(255) DEFAULT NULL,
  `fecha_de_inicio_de_vigencia_de_resolucion` varchar(255) DEFAULT NULL,
  `fecha_de_expiracion_resolucion` varchar(255) DEFAULT NULL,
  `fecha_expiración_de_resolucion_con_decreto_491` varchar(255) DEFAULT NULL,
  `compania_de_seguro_poliza` varchar(100) DEFAULT NULL,
  `fecha_expedicion_poliza` varchar(255) DEFAULT NULL,
  `fecha_vencimiento_poliza` varchar(255) DEFAULT NULL,
  `estado_de_la_poliza` varchar(255) DEFAULT NULL,
  `fecha_de_insercion` varchar(255) DEFAULT NULL,
  `fecha_de_actualizacion` varchar(255) DEFAULT NULL,
  `transnacional` varchar(255) DEFAULT NULL,
  `sise` varchar(255) DEFAULT NULL,
  `tramites_administrativos_sancionatorios` varchar(255) DEFAULT NULL,
  `auto_existencia_merito` varchar(255) DEFAULT NULL,
  `auto_de_apertura` varchar(255) DEFAULT NULL,
  `auto_de_cierre` varchar(255) DEFAULT NULL,
  `acto_administrativo_primera_instancia` varchar(255) DEFAULT NULL,
  `resuelve_recurso_reposicion_primera_instancia` varchar(255) DEFAULT NULL,
  `acto_administrativo_segunda_instancia` varchar(255) DEFAULT NULL,
  `conducta_ejercicio_irregular_inobservancia_de_los_principios` varchar(255) DEFAULT NULL,
  `sancion_impuesta` varchar(255) DEFAULT NULL,
  `oficios_de_comunicacion_a_prestador` varchar(255) DEFAULT NULL
...
--
ALTER TABLE `fuentes`
  MODIFY `id_fuente` tinyint(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
